# Kalo - App Fitness de Treino e Dieta
...
O **Kalo** é um aplicativo mobile projetado para revolucionar o acompanhamento de saúde, dietas e treinos. Com uma interface moderna, focada em performance e usabilidade, o app permite aos usuários registrarem suas refeições diárias, gerar seu plano de treino específico, acompanharem metas de macronutrientes, visualizarem o progresso de peso corporal e manterem um calendário de frequência de treinos. 
...
* **Cronograma de Treino:** Interface dinâmica para seleção de dias da semana e visualização dos exercícios planejados por grupo muscular.
* **Plano Diário e Pesquisa:** Fluxo completo para visualizar refeições do dia (Café, Almoço, Jantar), com sistema de busca de alimentos e seleção de gramas (`DiarioScreen` e `PesquisaAlimentosScreen`).
...
* **Ícones e Gráficos:** Lucide React Native e React Native Gifted Charts
